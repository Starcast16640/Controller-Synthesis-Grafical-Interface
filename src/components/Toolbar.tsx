...
export function Toolbar({ currentView, onViewChange, onExport, onJsonExport, onJsonImport }: ToolbarProps) {
  ...
  const sideBtnClass = "flex items-center justify-center w-[170px] gap-2 px-4 py-2 rounded-lg text-[13px] font-bold transition-all shadow-md h-10 uppercase whitespace-nowrap";
