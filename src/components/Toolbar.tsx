      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <div className="relative" ref={menuRef}>
            ...
            {isMenuOpen && (
              <div className="absolute top-full right-0 mt-2 w-54 bg-white rounded-xl shadow-xl border border-gray-200 overflow-hidden z-50 animate-in fade-in slide-in-from-top-2">
                <button
