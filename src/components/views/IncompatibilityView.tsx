    ...
    <div className="p-6 h-full flex flex-col">
      ...
      <div className="flex flex-1 gap-6 overflow-hidden mt-4">
        <div className="w-1/3 bg-white p-6 rounded-xl shadow-md border border-gray-200 flex flex-col">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">Select Tasks</h3>
          <p className="text-[12px] font-semibold text-gray-800 mb-4">Click tasks that cannot run at the same time.</p>
          ...
          <div className="flex gap-2 w-full mt-4">
            ...
            {editingId && (
              <button
                ...
                className="flex-1 h-12 px-4 py-2 bg-grey-600 text-black rounded-lg hover:bg-grey-700 transition-colors font-semibold text-sm shadow-md"
              >
                Cancel
              </button>
            )}
