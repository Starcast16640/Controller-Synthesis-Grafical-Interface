                  ...
                  {tasks.map(t => (
                    <button key={`src_${t.id}`} 
                      ...
                      className={`w-full text-left px-3 py-1.5 rounded text-[10px] font-bold transition-all border ${
                        sourceTasks.includes(t.id) ? 'bg-blue-600 border-blue-700 text-white shadow-md border-2' : 'bg-gray-50 border-gray-200 text-gray-500 hover:bg-blue-50'
                      }`}> 
                      {t.name}
                    </button>
                  ))}
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex justify-end gap-2">
                          ...
                          <button 
                            ...
                            className="text-blue-600 hover:text-blue-900 m-4"
                          >
